...
<body class="hold-transition login-page" style="background: url(assets/backgrounds/login1.jpg);background-size: 100%;background-repeat: no-repeat;">
<div class="login-box">
  <!-- /.login-logo -->
